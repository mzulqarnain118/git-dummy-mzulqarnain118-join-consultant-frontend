        ...
        <section className="havemore position-relative">
          <section className="consult-rgt-dts">
            <figure className="consult-img">
              ...
              <p>
                <sup className="topqt">‘</sup>We’ve been challenged and
                fulfilled through this opportunity, and the success we’ve
                experienced has encouraged us to continue pushing to achieve
                greater goals.
                <sup className="btmqt">’</sup>
              </p>
              <h5>Shelly Hoke, Ann Thompson and Lisa Oldham</h5>
            </figure>
          </section>
            ...
            <div class="accordion" id="accordionExample">
              <div class="accordion-item">
                ...
                >
                  <div class="accordion-body">
                    ...
                    flavor, color or aroma. The result is wine that is natural,
                    delicious and provides an all-around better wine experience
              ...
              <div class="accordion-item">
                <h3 class="accordion-header" id="headingFour">
                  ...
                  >
                    Why should I partner with an Independent Consultant instead
                    of just ordering Scout &amp; Cellar Clean-Crafted Wine
                    online?
                  </button>
                </h3>
                <div
              ...
              <div class="accordion-item">
                <h3 class="accordion-header" id="headingSix">
                  ...
                  >
                    How do I manage my account, change my membership options,
                    and/or update payment information?
                  </button>
                </h3>
                <div
                  id="collapseSix"
