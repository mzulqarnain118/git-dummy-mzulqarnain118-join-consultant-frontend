        ...
        <section className="partners text-center">
          <section className="container p-0">
            ...
            <p className="text-center">
              We’re committed to helping you succeed and have assembled a
              powerful set of tools to help you profit.
            </p>
            <section className="row d-flex flex-row m-0 justify-content-center align-items-start position-relative">
              ...
              <aside className="col-lg-6 col-md-6 col-12 gray-box p-0">
                <h3>Community</h3>
                <p>
                  The Scout &amp; Cellar Consultant community is always around
                  to help. Reach out to your referring Consultant or the Scout
                  &amp; Cellar Consultant Support team to work past questions or
              ...
              <aside className="col-lg-6 col-md-6 col-12 gray-box p-0">
                ...
                <p>
                  ...
                  <a
                    href="https://scoutandcellar.com/yourname"
                    title="www.scoutandcellar.com/yourname"
                  >
                    (www.scoutandcellar.com/yourname)
                  </a>
                  which you can use on all your marketing efforts. All sales
                  from your store accrue to your credit.
                </p>
                <span className="ic-gray-box">
              ...
              <aside className="col-lg-6 col-md-6 col-12 gray-box p-0">
                ...
                <p>
                  Track your sales, customers, earnings and more, from one
              ...
              <aside className="col-lg-6 col-md-6 col-12 gray-box p-0">
                ...
                <p>
                  Whether it’s using our tools or helping you sell, our vast
                  library of videos will help you get selling, right away.
                </p>
                <span className="ic-gray-box position-bottom">
